...
if($_SERVER["REQUEST_URI"]=='/kenniscentrum/nieuws.html'){
	header('Location: /kenniscentrum_nieuws');
	exit;
}
...
} elseif (in_array($_SERVER['SERVER_NAME'], array('www.hollandgold.be', 'hollandgold.be'))){
	if(isset($_COOKIE['dutchBelgium'])){
		Mage::run('hg_be_nl', 'store');
	} else {
