...
class Magestore_Affiliateplus_Adminhtml_PaymentController extends Mage_Adminhtml_Controller_Action
{
	...
	public function editAction() {
		...
		if ($payment->getId() || $id == 0) {
			...
			$this->_addBreadcrumb(Mage::helper('adminhtml')->__('Withdrawals Manager'), Mage::helper('adminhtml')->__('Withdrawals Manager'));
			$this->_addBreadcrumb(Mage::helper('adminhtml')->__('Withdrawal News'), Mage::helper('adminhtml')->__('Withdrawal News'));
	...
	public function saveAction() {
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('affiliateplus')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('affiliateplus')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
	}
