...
$installer->run("
  ...
  INSERT INTO `{$installer->getTable('exactonline/setting')}` (`visible`, `name`, `value`, `timestamp`, `label`, `category_id`, `field_type`, `is_editable_key`, `is_deletable`) VALUES(1, 'sync_direction', 'me', '2015-02-27 10:00:00', 'Customer Sync.', '9', '2', '0', '0');
