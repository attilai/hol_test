...
$installer->run("
DROP TABLE IF EXISTS {$this->getTable('googleshopping')};
 ");

 $installer->run("

CREATE TABLE {$this->getTable('googleshopping')} (
 `googleshopping_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `googleshopping_filename` varchar(255) DEFAULT NULL,
  `googleshopping_path` varchar(255) DEFAULT NULL,
  `googleshopping_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `store_id` int(11) NOT NULL DEFAULT '1',
  `googleshopping_url` varchar(120) DEFAULT NULL,
  `googleshopping_title` text ,
  `googleshopping_description` text ,
  `googleshopping_xmlitempattern` text,
  `googleshopping_categories` longtext,
  `googleshopping_type_ids` varchar(150) DEFAULT NULL,
  `googleshopping_visibility` varchar(10) DEFAULT NULL,
  `googleshopping_attributes` text ,
  `cron_expr` varchar(100) DEFAULT '0 4 * * *',
  PRIMARY KEY (`googleshopping_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

    ");
$installer->run("
	
	INSERT INTO `{$this->getTable('googleshopping')}` (`googleshopping_id`, `googleshopping_filename`, `googleshopping_path`, `googleshopping_time`, `store_id`, `googleshopping_url`, `googleshopping_title`, `googleshopping_description`, `googleshopping_xmlitempattern`, `googleshopping_categories`, `googleshopping_type_ids`, `googleshopping_visibility`, `googleshopping_attributes`) VALUES
