...
class Mirasvit_Fpc_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'general_cache_tags_level'     => 'Default - refresh cache if visible product changed, Extended set of tags - refresh cache also for associated products. Flush Fpc cache after changing.',
