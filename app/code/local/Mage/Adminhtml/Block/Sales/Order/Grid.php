...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumnAfter('exactonline_synced', array(
        ...
        $this->addColumnsOrder('real_order_id', 'exactonline_synced');
        ...
        $this->addColumn('grand_total', array(
            ...
            'filter_index' => '`sales_flat_invoice`.`grand_total`',
            'index' => 'grand_total',
            'type'  => 'currency',
        ...
        $this->addColumn('method_understand', array(
                ...
                'filter_index' => 'sales_flat_order_payment.method_understand',
                'index' => 'method_understand',
        ));
